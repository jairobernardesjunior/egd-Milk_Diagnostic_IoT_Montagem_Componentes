...
Adafruit_ESP8266 wifi(&softser, &Serial, ESP_TX);
// Must call begin() on the stream(s) before using Adafruit_ESP8266 object.

#define ESP_SSID "ixs" // Your network name here
#define ESP_PASS "delzirinha2016" // Your network password here

char EMAIL_FROM[] = "i4x.data@gmail.com";
char EMAIL_PASSWORD[] =  "xxxx2023@";
char EMAIL_TO[] = "jairobernardesjunior@gmail.com";
char SUBJECT[]  = "subject My ESP8266";
...
#define EMAIL_FROM_BASE64 "i4x.data@gmail.com"
#define EMAIL_PASSWORD_BASE64 "xxxx2023@"
