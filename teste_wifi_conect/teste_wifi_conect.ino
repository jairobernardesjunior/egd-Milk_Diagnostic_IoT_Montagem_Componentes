...
SoftwareSerial Serial1(7, 6); //PINOS QUE EMULAM A SERIAL, ONDE O PINO 6 É O RX E O PINO 7 É O TX
 
char ssid[] = "ixs"; //VARIÁVEL QUE ARMAZENA O NOME DA REDE SEM FIO
char pass[] = "delzirinha2016";//VARIÁVEL QUE ARMAZENA A SENHA DA REDE SEM FIO
...
void setup(){
  ...
  WiFi.config(IPAddress(192,168,100,123)); //COLOQUE UMA FAIXA DE IP DISPONÍVEL DO SEU ROTEADOR
